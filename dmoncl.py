...
class Monster:
    def __init__ (self, name: str, moves: dict, monID: int, 
                  attack_stat: int, speed_stat: int, defense_stat: int, health_stat: int, monType: str):
        self.name = name
        self.moves = moves
        self.monID = monID
    ...
    def Mondex(self, ID=None): #Method for getting all of our properties of a monster object
        ...
        print("Speed Stat:", self.speed_stat)
        print("Defense stat:", self.defense_stat)
        print("Health stat:", self.health_stat)
        print("Typing:", self.monType)
        

Orgo = Monster("Orgo", {"Moves": ["Punch"], "Type": ["Fire"]}, monID=1, attack_stat=10, speed_stat=12, defense_stat=11, health_stat=12, monType="Fire")
Borg = Monster("Borg", {"Moves": ["Smack"], "Type": ["Water"]}, monID=2, attack_stat=10, speed_stat=10, defense_stat=11, health_stat=12, monType="Water")
